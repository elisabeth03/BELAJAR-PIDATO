...
public class Kesehatandua extends AppCompatActivity {
    ListView listViewMenjagaK;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kesehatandua);
        listViewMenjagaK = (ListView) findViewById(R.id.kesehatandua);
        ...
        listViewMenjagaK.setAdapter(adapter);
    }
}
